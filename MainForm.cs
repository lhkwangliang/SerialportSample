...
namespace SerialportSample
{
    public partial class MainForm : Form
    {
        ...
        private void query1894UnitParams()
        {
            ...
            paramList.Add(pm);
            pm = new ParamItem("D302", "pvFrequencyMax", 2, "0", 2, "uint2", "MHz");
            paramList.Add(pm);
            pm = new ParamItem("D303", "pvRfinAgcPdet", 1, "0", 0, "uint1", "");
            paramList.Add(pm);
            pm = new ParamItem("D304", "pvRffbAgc", 1, "0", 0, "uint1", "");
            paramList.Add(pm);
            pm = new ParamItem("D305", "pvRfinPowerPmu", 2, "0", 100, "sint2", "");
            paramList.Add(pm);
            pm = new ParamItem("D306", "pvRffbPowerPmu", 2, "0", 100, "sint2", "");
            paramList.Add(pm);
            pm = new ParamItem("D307", "pvAverageCoeff", 2, "0", 10, "uint2", "");
            paramList.Add(pm);
            pm = new ParamItem("D308", "pvAlarmStatus", 1, "0", 0, "uint1", "");
            paramList.Add(pm);
            pm = new ParamItem("D309", "pvOverallStatus", 1, "0", 0, "uint1", "");
            paramList.Add(pm);
