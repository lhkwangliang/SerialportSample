...
namespace SerialportSample
{
    static class Program
    {
        ...
        private static void installMap()
        {
            ...
            //1894可写参数
            configParam("DF40", "pvFrequencyRangeW", 1, "", 0, "uint1", "");
            configParam("DF41", "pvFrequencyMinW", 2, "", 2, "uint2", "");
            configParam("DF42", "pvFrequencyMaxW", 2, "", 2, "uint2", "");
            configParam("DF43", "pvOutputControlW", 1, "", 0, "uint1", "");
            configParam("DF44", "pvSetCalParamAW", 1, "", 0, "uint1", "");
            configParam("DF45", "pvReset1894W", 1, "", 0, "uint1", "");
